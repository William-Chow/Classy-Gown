 ...
 */
public class ShippingTermsActivity extends BaseActivityWithoutExit implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_page_classy_gown_more_shipping_terms);
    ...
    private void setupLayout(){
        tvHomePageMoreSubHeaderTitle.setText(getResources().getText(R.string.home_page_more_shipping_title_sub_header));
    ...
    private void intentBack(){
        ShippingTermsActivity.this.finish();
        ShippingTermsActivity.this.overridePendingTransition(R.anim.animation_slide_in_left, R.anim.animation_slide_out_right);
    }
}
