...
/**
 * Created by William Chow on 12/22/15.
 */
public class ReturnAndExchangesActivity extends BaseActivityWithoutExit implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_page_classy_gown_more_returns_policy);
    ...
    private void setupLayout(){
        tvHomePageMoreSubHeaderTitle.setText(getResources().getText(R.string.home_page_more_return_policy_title_sub_header));
    ...
    private void intentBack(){
        ReturnAndExchangesActivity.this.finish();
        ReturnAndExchangesActivity.this.overridePendingTransition(R.anim.animation_slide_in_left, R.anim.animation_slide_out_right);
    }
}
