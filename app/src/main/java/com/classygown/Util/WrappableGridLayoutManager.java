...
/**
 * Created by William Chow on 2/2/2016.
 */
...
//        finalHeight += (20 * (getItemCount() / 2)) + 50;

        setMeasuredDimension(finalWidth, finalHeight + 450);
//        Log.i("William", "Check this one :: " + finalHeight + " Hi here :: " + finalWidth);
    }
